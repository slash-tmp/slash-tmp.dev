  ...
  <section class="home-quality">
    <Container>
      ...
      <p>
        ...
        une compétence pluridisciplinaire qui passe par — le code, le design, la
        rédaction, la gestion de projet...
      </p>
      <p>
        Cela semble être une évidence de pouvoir consulter et utiliser un site
        de la meilleure des manières possibles. Mais aussi parce qu'un site qui
        ne respecte pas ces principes peut coûter cher, très cher. On parle de
        ...
        déréferencement dans les moteurs de recherche, ventes non réalisées sur
        un site e-commerce, retard dans le traitement des réclamations… Autant
        de raisons qui nécessitent de s'intéresser et d'<strong
          >investir</strong
        >
        dans la <strong>qualité web</strong> !
      </p>
      <figure>
        <blockquote class="home-quality__quote">
